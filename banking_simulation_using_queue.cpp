...
int max_serv_time = 9; // maximum service time for one customer
int clock;
...
int remove_customer1()
{
	...
	printf("Taken by 1st banker. Customer %d starts service in %d minutes. Wait time was %d minutes.\n", customer.id, clock, clock - customer.arrival_time);
...
int remove_customer2()
{
	...
	served_customers++;
	waited_time += clock - customer.arrival_time;
	printf("Taken by 2nd banker. Customer %d starts service in %d minutes. Wait time was %d minutes.\n", customer.id, clock, clock - customer.arrival_time);
...
void main()
{
	...
	while (clock < duration) {
		...
		printf("service time 1: %d\n", service_time1);
		printf("service time 2: %d\n", service_time2);
		printf("----------------------------------------------------\n");
	}
	printf("Statistics\n");
	print_stat();
